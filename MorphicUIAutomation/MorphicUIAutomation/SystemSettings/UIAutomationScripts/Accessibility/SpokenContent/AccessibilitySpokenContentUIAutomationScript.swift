...
public class AccessibilitySpokenContentUIAutomationScript {
    public static func getSpeakSelectionIsEnabled(sequence: UIAutomationSequence? = nil, waitAtMost: TimeInterval) async throws -> Bool {
        ...
        let speakSelectionIsEnabled = try accessibilityDisplayCategoryPane.getValue(forCheckboxWithIdentifier: SystemSettingsAccessibilitySpokenContentCategoryPane.Checkbox.speakSelection)
    ...
    public static func setSpeakSelectionIsEnabled(_ value: Bool, sequence: UIAutomationSequence? = nil, waitAtMost: TimeInterval) async throws {
        ...
        try accessibilityDisplayCategoryPane.setValue(value, forCheckboxWithIdentifier: SystemSettingsAccessibilitySpokenContentCategoryPane.Checkbox.speakSelection)
        ...
        let verifySuccess = try await AsyncUtils.wait(atMost: remainingWaitTime) {
            let checkboxValue = try accessibilityDisplayCategoryPane.getValue(forCheckboxWithIdentifier: SystemSettingsAccessibilitySpokenContentCategoryPane.Checkbox.speakSelection)
    ...
    private static func launchOrAttachSystemSettingsThenNavigativeToAccessibilitySpokenContent(sequence: UIAutomationSequence?, waitFor: TimeInterval) async throws -> SystemSettingsAccessibilitySpokenContentCategoryPane {
        ...
        return categoryPane as! SystemSettingsAccessibilitySpokenContentCategoryPane
    }
}
