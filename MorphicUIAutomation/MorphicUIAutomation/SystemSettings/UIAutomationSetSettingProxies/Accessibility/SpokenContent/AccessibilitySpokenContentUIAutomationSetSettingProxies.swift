...
public class SpeakSelectedTextEnabledUIAutomation: UIAutomationSetSettingProxy {
    ...
    public func apply(_ value: Interoperable?) async throws {
        ...
        try await AccessibilitySpokenContentUIAutomationScript.setSpeakSelectionIsEnabled(valueAsBool, waitAtMost: waitForTimespan)
    }
}
